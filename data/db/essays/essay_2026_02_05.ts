...
const redacaoData: RedacaoSpecificData = {
  temaSugrido: "Racismo ambiental como desafio contemporâneo brasileiro",
  competencias: [
    { id: 'C1', nome: 'Norma Culta', nota: 160, meta: 200, descricao: '2 Erros apontados: Presença de rasura e pequenos desvios de sintaxe/acentuação solicitados pelo corretor.' },
    ...
    { id: 'C4', nome: 'Coesão', nota: 160, meta: 200, descricao: '6 Erros apontados: Uso repetitivo ou mal empregado de operadores argumentativos entre os períodos.' },
  ...
  textoTranscrito: [
    ...
    { lineNumber: 23, text: 'liar o crescimento econômico com a preservação ambiental.', errors: [{ term: 'econômico', correction: 'economico', type: 'grammar', description: 'C1: Dica do Corretor - excluir o acento indevido (sinalizado de forma figurativa).' }] },
  ...
  manualConstrucao: {
    titulo: "Guia: Repertório Vivo e Coesão Avançada",
    passos: [
      {
        titulo: "ESTEIRA ARGUMENTATIVA (D1 e D2)",
        descricao: "Inicie sempre seu Desenvolvimento com Operadores de Particularização ('Sob esse viés') e Operadores de Adição ('Ademais') para mostrar que suas ideias estão interligadas."
      },
      {
        titulo: "REFLEXÃO DO REPERTÓRIO",
        descricao: "Logo após apresentar os dados ou a citação, utilize um Operador de Afirmação ('Efetivamente', 'Nessa perspectiva') para amarrar o fato ao argumento central."
      },
      {
        titulo: "FECHAMENTO COESO",
        descricao: "Todo último período de parágrafo merece uma microconclusão. Sinalize com: 'Logo,', 'Dessa forma,' ou 'Destarte,'."
      }
    ],
    dicasGramaticais: "Rasuras como em '(da ra)' são marcadas pela Competência I. Caso erre, faça um traço único fino sobre a palavra e siga (Ex: ~~da ra~~ da). Na correção C1, esteja extremamente atento a concordâncias e pontuação com verbos implícitos.",
    vocabularioJuizo: [
      "Alicerce", "Mitigar", "Assegurando", "Vulnerabilidade", "Marginalizados",
      "Assimetria", "Continuidade", "Indispensável", "Civilização", "Desenvolvimento"
    ],
    notaFinal: "Sua redação atingiu maravilhosos 920 pontos. C2, C3 e C5 são brilhantes. Você está muito próximo ao 1000; basta agora refinar a \"costura\" entre os parágrafos utilizando o manual de operadores lógicos."
  }
};

export const essay_2026_02_05: MateriaData = {
  ...criarTemplateVazio('Redação', 2026),
  id: 'red_920_racismo',
  dataRealizacao: '2026-02-05',
  notaAtual: 920,
  meta: 900,
  gap: 0,
  tempo: '1h12',
