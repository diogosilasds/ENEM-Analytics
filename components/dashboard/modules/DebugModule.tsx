...
import { DebugReport, DebugTarget } from '../../../types';
import { ScanEye, Crosshair, Target, Flame, TrendingUp, Layers, HelpCircle, FileText, ChevronRight, AlertOctagon, Terminal, Activity, Lock, ShieldCheck, ArrowUpRight, AlertTriangle } from 'lucide-react';
import { ResponsiveContainer, XAxis, YAxis, Tooltip, CartesianGrid, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Radar, BarChart, Bar, Legend, LineChart, Line, Treemap } from 'recharts';
